# Jenkins (CI/CD): основы и продвинутые задачи из реальной жизни.

Этот набор заданий разработан в рамках проекта 90DaysOfDevOps и призван имитировать реальные сценарии, с которыми вы можете столкнуться на работе или на технических собеседованиях. Выполняя эти задания, вы получите практический опыт работы с продвинутыми темами Jenkins, включая конвейеры, распределенные агенты, RBAC, общие библиотеки, сканирование уязвимостей и автоматические уведомления.

Выполните каждое задание и задокументируйте все шаги, команды, скриншоты и наблюдения в файле с именем `solution.md`. Эта документация послужит вам как руководством по подготовке, так и элементом портфолио для собеседований.

---

## Задача 1: Создайте задание пайплайна Jenkins для CI/CD.

**Сценарий:**  
Создайте сквозной конвейер CI/CD для тестового приложения.

**Шаги:**
1. **Настройка задания пайплайна:**  
   - Создайте новое задание конвейера в Jenkins.
   - Напишите простой файл Jenkinsfile, который автоматизирует сборку, тестирование и развертывание тестового приложения (например, простого веб-приложения).  
   - Предлагаемые этапы: **Build**, **Test**, **Deploy**.
2. **Запустите и проверьте конвейер:**  
   - Запустите конвейер и убедитесь, что каждый этап выполняется успешно.
   - Проверьте выполнение, просмотрев логи консоли и, если применимо, используя команду `docker ps` для подтверждения состояния контейнера.
3. **Запишите в `solution.md`:**  
   - Приложите код из файла Jenkinsfile и объясните назначение каждого этапа.
   - Запишите все возникшие проблемы и способы их решения.

**Вопросы для собеседования:**
— Как декларативные конвейеры упрощают процесс CI/CD по сравнению со скриптовыми конвейерами?
— Каковы преимущества разделения конвейера на отдельные этапы?
